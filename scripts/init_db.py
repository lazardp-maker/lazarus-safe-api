...
CREATE INDEX IF NOT EXISTS idx_incidents_county_city_type
ON incidents(county, city, incident_type);
...
CREATE INDEX IF NOT EXISTS idx_incidents_primary_source_id
ON incidents(primary_source_id);

CREATE INDEX IF NOT EXISTS idx_incidents_article_id
ON incidents(article_id);
...
CREATE INDEX IF NOT EXISTS idx_incident_mentions_article_id
ON incident_mentions(article_id);
